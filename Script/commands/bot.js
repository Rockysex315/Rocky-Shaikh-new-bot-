...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Rocky sun") || (event.body.toLowerCase() == "Rocky koi") || (event.body.toLowerCase() == "ROCKY BHAIッ") || (event.body.toLowerCase() == "@ROCKY▁▁▁▁╱╱😈😘🥵😛🪽")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐑𝐎𝐂𝐊𝐘 ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐑𝐎𝐂𝐊𝐘.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=61564434359130\nতার সাতে যোগা যোগ করবেন WhatsApp :- +9122085***", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Rockyッ❤️ তাকে সবাই রকি নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "Sala ami tor boss") || (event.body.toLowerCase() == "Sala ami rocky") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "ALISA") || (event.body.toLowerCase() == "তানিয়া")) {
  ...
  if ((event.body.toLowerCase() == "SUMU") || (event.body.toLowerCase() == "তানু")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রকি এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "ROCKY ") || (event.body.toLowerCase() == "রকি")) {
     return api.sendMessage("🥰-rocky-🌺 আমার বস jony sins 'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে আমার বস রকি কে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Rocky er sona", threadID);
   };

   if ((event.body.toLowerCase() == "বট এর বাচ্চা") || (event.body.toLowerCase() == "Bot er bacca")) {
   ...
   if ((event.body.toLowerCase() == "mia Khalifa") || (event.body.toLowerCase() == "ex")) {
