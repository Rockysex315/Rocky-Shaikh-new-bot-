...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Rocky") || (event.body.toLowerCase() == "rocky vai") || (event.body.toLowerCase() == "@ROCKY▁▁▁▁╱╱😈😘🥵😛🪽 ッ") || (event.body.toLowerCase() == "উল্লাস")) {
     return api.sendMessage("𝐅𝐦𝐳 𝐑𝐨𝐜𝐤𝐲 বস এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑: 𝐅𝐦𝐳 𝐑𝐨𝐜𝐤𝐲☞  ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐑𝐎𝐂𝐊𝐘.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/1E3VEK1wGN/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +9120858***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝐅𝐦𝐳 𝐑𝐨𝐜𝐤𝐲 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস 𝐑𝐨𝐜𝐤𝐲 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("🄷🅴𝒀 𝐈🅢 🅡𝐎🅒𝐊🅨 ッ❤️ তাকে সবাই 𝐅𝐦𝐳 𝐑𝐨𝐜𝐤𝐲 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami uncle") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি রকি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@প্রি্ঁয়্ঁ'শী্ঁ ত্যা্ঁ'হ্ঁ") || (event.body.toLowerCase() == "Nilima")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস রকি এর ফ্রেন্ড এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রকি এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "Mim")) {
     return api.sendMessage("কেও নক দিবি না বস 𝐅𝐌𝐙 𝐑𝐎𝐂𝐊𝐘 এর সালি লাগে ..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "best friend") || (event.body.toLowerCase() == "bestu")) {
     return api.sendMessage("🥰--🌺 আমার বস রকি'র বেস্ট ফ্রেন্ড নাই😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে বস রকি কে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝐑𝐎𝐂𝐊𝐘 𝐒 𝐒𝐎𝐍𝐀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন বস রকি তো আছ🫶/nতোমাকে রাইতে ভালোবাসে", threadID);
   };

   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার বস রকি কে একটা গফ দে<🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে রকি বস এর ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "mon kharap") || (event.body.toLowerCase() == "tmr ki mon kharap")) {
     return api.sendMessage("হ্যাঁ মন খারাপ রকি বস সিঙ্গেল তাই বোকা দিচ্ছে ...!🌝", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Ami malik tor") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হম বস আমি আপনার গোলাম..?☺️", threadID);
   };
  mess = "{name}"
